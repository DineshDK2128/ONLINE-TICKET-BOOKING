...
online= mysql.connector.connect(
    host="localhost",
    user="root",
    password="6383007540",
    database="Bus"
...
def bus_ticket(starting,ending,how,name):
    ...
    show=mycursor.fetchall()
    result=show[0]
    if starting=="Tiruvannamalai" and ending=="vellore":
        # Tiruvannamalai_vellore=120
        total=how*120
        print(f"Starting-point ='{starting}'")
        print(f"ending-point ='{ending}'")
        print(f" how many ticket ='{how}'")
        print(f"Total Cast For Ticket ='{total}'")
    elif starting == "Tiruvannamalai" and ending=="kanchipuram":
        # Tiruvannamalai_kanchipuram=100
        total=how*100
        print(f"Starting-point ='{starting}'")
        print(f"ending-point ='{ending}'")
        print(f" how many ticket ='{how}'")
        print(f"Total Cast For Ticket ='{total}'")
    elif starting == "Tiruvannamalai" and ending=="chennai":
        # Tiruvannamalai_chennai=150
        total=how*150
        print(f"Starting-point ='{starting}'")
        print(f"ending-point ='{ending}'")
        print(f" how many ticket ='{how}'")
